...
class EvaluationHistory:
    ...
    def get_cached_result(self, request: EvalRequest) -> Optional[EvalResult]:
...
_history_instance: Optional[EvaluationHistory] = None


def get_history(history_file: Optional[Path] = None) -> EvaluationHistory:
