...
class EvalRule(BaseModel):
    ...
    description: str = Field(description="Human-readable description of what this rule evaluates")
...
class EvalRequest(BaseModel):
    ...
    threshold: float = Field(default=0.7, description="Minimum score threshold for passing")
...
class EvalResult(BaseModel):
    ...
    request: EvalRequest = Field(description="Original request that generated this result")
