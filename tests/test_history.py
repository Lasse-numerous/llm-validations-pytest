...
from numerous.pytest_llm_validate.history import EvaluationHistory, get_history, reset_history_instance
...
class TestEvaluationHistory:
    ...
    def test_normalize_artifacts(self) -> None:
        ...
        try:
            ...
            assert isinstance(normalized["complex"], str)  # Should be converted to string
